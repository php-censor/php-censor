...
ви виконаєте composer update.',
    ...
    'overwrite_build_config' =>'Перезаписати конфігурацію файлу в сховищі конфігурацією в базі даних? Якщо прапорець не встановлено, конфігурація в базі даних буде об’єднана з файлом config.',
    ...
    'codeception_synopsis' =>'Тестов виконано: <strong>%1$d</strong> (за <strong>%2$f</strong> сек.). Невдач : <strong>%3$d</strong>.',
    'suite' =>'Набір',
    'test' =>'Тест',
    ...
    'started' =>'Почалося',
    'finished' =>'Закінчено',
    'add_to_queue_failed' =>'Збірка успішно створена, але виникла проблема при додаванні збірки в чергу. Зазвичай таке відбувається, коли PHP Censor намагається працювати з неіснуючим або зупиненим сервером черг Beanstalkd.',
    'critical' =>'Критичний',
    'high' =>'Високий',
    'normal' =>'Нормальний',
    'low' =>'Низький',
