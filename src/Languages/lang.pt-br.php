...
return [
    ...
    'reset_no_user_exists' => 'Nenhum usuário existe com esse endereço de email, por favor tente novamente.',
...
PHP Censor',
    ...
    'x_of_x_failed' => '%d das últimos %d compilações falharam.',
    ...
    'last_failed_build' => ' A última compilação fracassada foi %s.',
    'never_failed_build' => ' Este projeto nunca teve uma compilação fracassada.',
    ...
    'github_sign_in' => 'Antes de começar a usar o GitHub, você precisa <a href="%s">se autenticar</a> e permitir que o
    ...
    'failed_after' => 'Considere uma compilação como fracassada após',
    '5_mins' => '5 Minutos',
    '15_mins' => '15 Minutos',
    '30_mins' => '30 Minutos',
    '1_hour' => '1 Hora',
    ...
    // Plugins
    'cannot_update_composer' => 'PHP Censor não pode atualizar o composer.json por você pois não pois não é gravável.',
    ...
    'failing_build' => 'Compilação Fracassada',
